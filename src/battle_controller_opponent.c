        ...
        else if (gBattleTypeFlags & BATTLE_TYPE_DOUBLE)
        {
            ...
            if (!(gBattleMoves[move].target & MOVE_TARGET_BOTH))
            {
                ...
                static const u16 naturalEnemies[][2] =
                {
                    ...
                    {SPECIES_MAROWAK, SPECIES_MANDIBUZZ},
                    ...
                    {SPECIES_PELIPPER,    SPECIES_PYUKUMUKU},
                    {SPECIES_SABLEYE, SPECIES_CARBINK},
                    {SPECIES_SHARPEDO,    SPECIES_SQUIRTLE},
                    ...
                    {SPECIES_RAYQUAZA,    SPECIES_MINIOR},
                    {SPECIES_STARLY,  SPECIES_WURMPLE},
                    {SPECIES_STARLY,  SPECIES_CHERUBI},
                    {SPECIES_DRIFBLIM,    SPECIES_CLAMPERL},
                    ...
                    {SPECIES_FRILLISH,    SPECIES_MAGIKARP},
                    {SPECIES_BEHEEYEM,    SPECIES_DUBWOOL},
                    {SPECIES_DRUDDIGON,   SPECIES_DIGLETT},
                    {SPECIES_DRUDDIGON,   SPECIES_DUGTRIO},
                    ...
                    {SPECIES_CENTISKORCH, SPECIES_SCOLIPEDE},
                    {SPECIES_GRAPPLOCT,   SPECIES_GOLISOPOD},
                    /*
                    ...
                    {SPECIES_GRAFAIAI,    SPECIES_SCATTERBUG},           
                    */
                    //Rivals
                    ...
                    */
                    ...
                    {SPECIES_CUTIEFLY,  SPECIES_BUTTERFREE},
                    {SPECIES_TEDDIURSA, SPECIES_BEEDRILL},
                    {SPECIES_SHIINOTIC, SPECIES_PARASECT},
                    {SPECIES_MURKROW,   SPECIES_MEOWTH},
                    {SPECIES_URSARING,  SPECIES_PRIMEAPE},
                    {SPECIES_HAWLUCHA,  SPECIES_PRIMEAPE},
                    {SPECIES_ROCKRUFF,  SPECIES_GROWLITHE},
                    {SPECIES_VIKAVOLT,  SPECIES_PINSIR},
                    {SPECIES_LUMINEON,  SPECIES_LANTURN},
                    {SPECIES_VIKAVOLT,  SPECIES_HERACROSS},
                    {SPECIES_DEWPIDER,  SPECIES_SURSKIT},
                    {SPECIES_GABITE,    SPECIES_SABLEYE},
                    {SPECIES_BASCULIN,  SPECIES_CARVANHA},
                    {SPECIES_GARCHOMP,  SPECIES_SALAMENCE},
                    {SPECIES_PASSIMIAN, SPECIES_AMBIPOM},
                    /*
                    {SPECIES_SQUAWKABILLY,  SPECIES_FLETCHLING},
                    {SPECIES_FRIGIBAX,  SPECIES_BERGMITE},
                    */
                    {SPECIES_BRUXISH,   SPECIES_TOXAPEX},
                    //{SPECIES_FINIZEN,   SPECIES_BARRASKEWDA},
                    ...
                    {SPECIES_TOGEDEMARU,    SPECIES_ELEKID},
                    /*
