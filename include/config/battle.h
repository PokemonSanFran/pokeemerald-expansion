...
#define B_WILD_NATURAL_ENEMIES          TRUE       // If set to TRUE, certain wild mon species will attack other species when partnered in double wild battles (eg. Zangoose vs Seviper). This list only uses Pokémon that attack each other in Gen 6, Gen 7, or Gen 8
#define B_WILD_EXPANDED_ENEMIES         TRUE       // If set to TRUE, and B_WILD_NATURAL_ENEMIES is also set to TRUE, certain wild mon species will attack other species when partnered in double wild battles (eg. Zangoose vs Seviper). This list uses Pokémon that have an antagonistic relationship according to the Pokédex
